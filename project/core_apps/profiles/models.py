...
class Profile(TimeStampedModel):
    ...
    phone_number = PhoneNumberField(verbose_name=_("phone_number"), max_length=30, default="+250784123456")
    ...
    city = models.CharField(verbose_name=_("city"), max_length=180, default="Bengaluru", blank=False, null=False)
